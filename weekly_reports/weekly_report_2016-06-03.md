...
- Successfully accessed EnrichmentMap namespace commands in Cytoscape via R and RCy3. Created a function using RCy3 (using S4 framework) to access these commands. [See this section file](https://github.com/jooolia/Rcy3_vignettes/blob/46e12dac967463f5e0808d723c9fb1d2bc727973/playing_around_with_Rcy3.md#finding-command-names-available-in-cytoscape-using-r)
