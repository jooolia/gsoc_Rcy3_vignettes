...
- Successfully accessed EnrichmentMap namespace commands in Cytoscape via R and RCy3. Created a function using RCy3 (using S4 framework) to access these commands. [See this section file](https://github.com/jooolia/gsoc_Rcy3_vignettes/playing_around_with_Rcy3.md#finding-command-names-available-in-cytoscape-using-r)
